...
int main(void) {
  ...
  tcase_add_test(tc1_1, s21_create_matrix_10);
  ...
  tcase_add_test(tc1_1, s21_sum_matrix_09);
  ...
  tcase_add_test(tc1_1, s21_sub_matrix_09);
  ...
  tcase_add_test(tc1_1, s21_mult_matrix_07);
  ...
  tcase_add_test(tc1_1, s21_inverse_matrix_02);
  ...
  tcase_add_test(tc1_1, no_rows);
  tcase_add_test(tc1_1, no_cols);
  tcase_add_test(tc1_1, empty);
  tcase_add_test(tc1_1, size_mismatch);
